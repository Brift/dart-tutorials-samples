...
void init_autogenerated() {
  ...
  final __html0 = new autogenerated.Element.html('<h4>You chose:</h4>', treeSanitizer: autogenerated.nullTreeSanitizer), __html1 = new autogenerated.Element.html('<select multiple="" id="bookselector">\n            <option style="display:none"></option>\n        </select>', treeSanitizer: autogenerated.nullTreeSanitizer), __html2 = new autogenerated.Element.html('<option template="" repeat="key in books.keys"></option>', treeSanitizer: autogenerated.nullTreeSanitizer), __html3 = new autogenerated.Element.html('<ul>\n           <li style="display:none"></li>\n        </ul>', treeSanitizer: autogenerated.nullTreeSanitizer), __html4 = new autogenerated.Element.html('<li template="" repeat="selected in booksselected"></li>', treeSanitizer: autogenerated.nullTreeSanitizer);
  var __e8;
