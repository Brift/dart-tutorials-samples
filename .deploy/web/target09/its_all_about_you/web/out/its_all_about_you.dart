...
String __$intAsJson;
String get intAsJson {
  if (__observe.observeReads) {
    __observe.notifyRead(__changes, __observe.ChangeRecord.FIELD, 'intAsJson');
  }
  return __$intAsJson;
}
set intAsJson(String value) {
  if (__observe.hasObservers(__changes)) {
    __observe.notifyChange(__changes, __observe.ChangeRecord.FIELD, 'intAsJson',
        __$intAsJson, value);
  }
  __$intAsJson = value;
}
String __$doubleAsJson;
String get doubleAsJson {
  if (__observe.observeReads) {
    __observe.notifyRead(__changes, __observe.ChangeRecord.FIELD, 'doubleAsJson');
  }
  return __$doubleAsJson;
}
set doubleAsJson(String value) {
  if (__observe.hasObservers(__changes)) {
    __observe.notifyChange(__changes, __observe.ChangeRecord.FIELD, 'doubleAsJson',
        __$doubleAsJson, value);
  }
  __$doubleAsJson = value;
}
String __$stringAsJson;
String get stringAsJson {
  if (__observe.observeReads) {
    __observe.notifyRead(__changes, __observe.ChangeRecord.FIELD, 'stringAsJson');
  }
  return __$stringAsJson;
}
set stringAsJson(String value) {
  if (__observe.hasObservers(__changes)) {
    __observe.notifyChange(__changes, __observe.ChangeRecord.FIELD, 'stringAsJson',
        __$stringAsJson, value);
  }
  __$stringAsJson = value;
}
String __$listAsJson;
String get listAsJson {
  if (__observe.observeReads) {
    __observe.notifyRead(__changes, __observe.ChangeRecord.FIELD, 'listAsJson');
  }
  return __$listAsJson;
}
set listAsJson(String value) {
  if (__observe.hasObservers(__changes)) {
    __observe.notifyChange(__changes, __observe.ChangeRecord.FIELD, 'listAsJson',
        __$listAsJson, value);
  }
  __$listAsJson = value;
}
String __$boolAsJson;
String get boolAsJson {
  if (__observe.observeReads) {
    __observe.notifyRead(__changes, __observe.ChangeRecord.FIELD, 'boolAsJson');
  }
  return __$boolAsJson;
}
set boolAsJson(String value) {
  if (__observe.hasObservers(__changes)) {
    __observe.notifyChange(__changes, __observe.ChangeRecord.FIELD, 'boolAsJson',
        __$boolAsJson, value);
  }
  __$boolAsJson = value;
}
String __$mapAsJson;
String get mapAsJson {
  if (__observe.observeReads) {
    __observe.notifyRead(__changes, __observe.ChangeRecord.FIELD, 'mapAsJson');
  }
  return __$mapAsJson;
}
set mapAsJson(String value) {
  if (__observe.hasObservers(__changes)) {
    __observe.notifyChange(__changes, __observe.ChangeRecord.FIELD, 'mapAsJson',
        __$mapAsJson, value);
  }
  __$mapAsJson = value;
}
